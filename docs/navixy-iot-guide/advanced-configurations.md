...
> You can also create a completely new flow with this configuration by using [`POST /iot/logic/flow/create`](/broken/pages/e304ee5680b8d0536f06a8cee20271a978ea021b#post-iot-logic-flow-create)
...
You can then validate the configuration of the updated flow using the `read` endpoint: [`POST /iot/logic/flow/read`](/broken/pages/e304ee5680b8d0536f06a8cee20271a978ea021b#get-iot-logic-flow-read)
