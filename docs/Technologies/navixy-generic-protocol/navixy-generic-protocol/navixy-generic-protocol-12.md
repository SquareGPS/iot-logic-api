...
<table><thead><tr><th width="147">Attribute</th><th width="89">Type</th><th width="94">Object</th><th width="108">Required</th><th>Description</th></tr></thead><tbody><tr><td></td><td></td><td></td><td></td><td></td></tr><tr><td>└─ source_type</td><td>String</td><td>location</td><td>No</td><td>Positioning source. Possible values: <code>GNSS</code> (satellite), <code>LBS</code> (cell tower-based), <code>ATLAS</code> (third-party positioning service).</td></tr><tr><td>└─ precision</td><td>Integer</td><td>location</td><td>No</td><td>Location accuracy in meters. Most relevant for LBS positioning, where accuracy can vary significantly.</td></tr></tbody></table>
